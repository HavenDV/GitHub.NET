...
namespace GitHub
{
    ...
    public sealed partial class WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchaseAccount
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchaseAccount" /> class.
        /// </summary>
        /// <param name="id"></param>
        ...
        public WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchaseAccount(
            int id,
            string login,
            string nodeId,
