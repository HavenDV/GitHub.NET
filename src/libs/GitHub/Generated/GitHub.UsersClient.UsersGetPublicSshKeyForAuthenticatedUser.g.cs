...
namespace GitHub
{
    public partial class UsersClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Key> UsersGetPublicSshKeyForAuthenticatedUserAsync(
            int keyId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.Key.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.Key.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
