...
namespace GitHub
{
    ...
    public sealed partial class WebhooksIssuePerformedViaGithubAppOwner
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhooksIssuePerformedViaGithubAppOwner" /> class.
        /// </summary>
...
#endif
        public WebhooksIssuePerformedViaGithubAppOwner(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhooksIssuePerformedViaGithubAppOwnerType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
