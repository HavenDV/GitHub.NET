...
namespace GitHub
{
    public partial class CodeScanningClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.CodeScanningAnalysisDeletion> CodeScanningDeleteAnalysisAsync(
            string owner,
            string repo,
            int analysisId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                global::GitHub.CodeScanningDeleteAnalysisResponse? __value_503 = null;
                if (ReadResponseAsString)
                {
                    __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = global::GitHub.CodeScanningDeleteAnalysisResponse.FromJson(__content_503, JsonSerializerContext);
                }
                else
                {
                    var __contentStream_503 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = await global::GitHub.CodeScanningDeleteAnalysisResponse.FromJsonStreamAsync(__contentStream_503, JsonSerializerContext).ConfigureAwait(false);
                }

                throw new global::GitHub.ApiException<global::GitHub.CodeScanningDeleteAnalysisResponse>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.CodeScanningAnalysisDeletion.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
