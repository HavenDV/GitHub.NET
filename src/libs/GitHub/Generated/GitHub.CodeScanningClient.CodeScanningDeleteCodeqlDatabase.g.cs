    ...
    public partial class CodeScanningClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                global::GitHub.CodeScanningDeleteCodeqlDatabaseResponse? __value_503 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_503 = global::GitHub.CodeScanningDeleteCodeqlDatabaseResponse.FromJson(__content_503, JsonSerializerContext);
                    }
                    else
                    {
                        var __contentStream_503 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                        __value_503 = await global::GitHub.CodeScanningDeleteCodeqlDatabaseResponse.FromJsonStreamAsync(__contentStream_503, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
                ...
                throw new global::GitHub.ApiException<global::GitHub.CodeScanningDeleteCodeqlDatabaseResponse>(
