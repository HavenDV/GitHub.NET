...
namespace GitHub
{
    ...
    public sealed partial class WebhookMembershipAddedSender
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookMembershipAddedSender" /> class.
        /// </summary>
        ...
        public WebhookMembershipAddedSender(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhookMembershipAddedSenderType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
