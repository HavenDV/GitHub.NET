...
namespace GitHub
{
    public partial class RateLimitClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.RateLimitOverview> RateLimitGetAsync(
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.RateLimitOverview.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.RateLimitOverview.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
