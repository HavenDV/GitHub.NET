...
namespace GitHub
{
    public partial class ProjectsClient
    {
        partial void PrepareProjectsUpdateArguments(
            ...
            ref int projectId,
            global::GitHub.ProjectsUpdateRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Project> ProjectsUpdateAsync(
            int projectId,
            global::GitHub.ProjectsUpdateRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 403)
            {
                ...
                global::GitHub.ProjectsUpdateResponse? __value_403 = null;
                if (ReadResponseAsString)
                {
                    __content_403 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                    __value_403 = global::GitHub.ProjectsUpdateResponse.FromJson(__content_403, JsonSerializerContext);
                }
                else
                {
                    var __contentStream_403 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                    __value_403 = await global::GitHub.ProjectsUpdateResponse.FromJsonStreamAsync(__contentStream_403, JsonSerializerContext).ConfigureAwait(false);
                }

                throw new global::GitHub.ApiException<global::GitHub.ProjectsUpdateResponse>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            else
            {
                ...
                return
                    await global::GitHub.Project.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Project> ProjectsUpdateAsync(
            ...
            global::GitHub.ProjectsUpdateRequestOrganizationPermission? organizationPermission = default,
            bool? @private = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.ProjectsUpdateRequest
            {
                Name = name,
                Body = body,
                State = state,
