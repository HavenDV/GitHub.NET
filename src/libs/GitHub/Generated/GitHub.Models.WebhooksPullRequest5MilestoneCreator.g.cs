...
namespace GitHub
{
    ...
    public sealed partial class WebhooksPullRequest5MilestoneCreator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhooksPullRequest5MilestoneCreator" /> class.
        /// </summary>
        ...
        public WebhooksPullRequest5MilestoneCreator(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhooksPullRequest5MilestoneCreatorType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
