...
namespace GitHub
{
    public partial class ActionsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Job> ActionsGetJobForWorkflowRunAsync(
            string owner,
            string repo,
            int jobId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.Job.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.Job.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
