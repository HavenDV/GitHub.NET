...
namespace GitHub
{
    public partial class GistsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.GistSimple> GistsGetAsync(
            string gistId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 403)
            {
                ...
                global::GitHub.GistsGetResponse? __value_403 = null;
                if (ReadResponseAsString)
                {
                    __content_403 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                    __value_403 = global::GitHub.GistsGetResponse.FromJson(__content_403, JsonSerializerContext);
                }
                else
                {
                    var __contentStream_403 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                    __value_403 = await global::GitHub.GistsGetResponse.FromJsonStreamAsync(__contentStream_403, JsonSerializerContext).ConfigureAwait(false);
                }

                throw new global::GitHub.ApiException<global::GitHub.GistsGetResponse>(
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.GistSimple.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
