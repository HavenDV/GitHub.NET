...
namespace GitHub
{
    ...
    {
        partial void PrepareProjectsGetFieldForUserArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int projectNumber,
            ref int fieldId,
            ref string userId);
        partial void PrepareProjectsGetFieldForUserRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int projectNumber,
            int fieldId,
            string userId);
        partial void ProcessProjectsGetFieldForUserResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsGetFieldForUserResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.ProjectsV2Field> ProjectsGetFieldForUserAsync(
            int projectNumber,
            int fieldId,
            string userId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsGetFieldForUserArguments(
            ...
            var __pathBuilder = new global::GitHub.PathBuilder(
                path: $"/users/{userId}/projectsV2/{projectNumber}/fields/{fieldId}",
            ...
            PrepareProjectsGetFieldForUserRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessProjectsGetFieldForUserResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessProjectsGetFieldForUserResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::GitHub.ProjectsV2Field.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::GitHub.ProjectsV2Field.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
