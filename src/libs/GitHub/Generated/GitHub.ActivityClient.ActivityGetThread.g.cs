...
namespace GitHub
{
    public partial class ActivityClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Thread> ActivityGetThreadAsync(
            int threadId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.Thread.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.Thread.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
