...
namespace GitHub
{
    ...
    {
        partial void PrepareEnterpriseTeamMembershipsBulkAddArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string enterprise,
            ref string enterpriseTeam,
            global::GitHub.EnterpriseTeamMembershipsBulkAddRequest request);
        partial void PrepareEnterpriseTeamMembershipsBulkAddRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string enterprise,
            string enterpriseTeam,
            global::GitHub.EnterpriseTeamMembershipsBulkAddRequest request);
        partial void ProcessEnterpriseTeamMembershipsBulkAddResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEnterpriseTeamMembershipsBulkAddResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::GitHub.SimpleUser>> EnterpriseTeamMembershipsBulkAddAsync(
            string enterprise,
            string enterpriseTeam,
            global::GitHub.EnterpriseTeamMembershipsBulkAddRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEnterpriseTeamMembershipsBulkAddArguments(
            ...
            PrepareEnterpriseTeamMembershipsBulkAddRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessEnterpriseTeamMembershipsBulkAddResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessEnterpriseTeamMembershipsBulkAddResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::GitHub.SimpleUser>> EnterpriseTeamMembershipsBulkAddAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.EnterpriseTeamMembershipsBulkAddRequest
            {
                Usernames = usernames,
            };

            return await EnterpriseTeamMembershipsBulkAddAsync(
                enterprise: enterprise,
                enterpriseTeam: enterpriseTeam,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
