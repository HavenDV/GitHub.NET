...
namespace GitHub
{
    ...
    public sealed partial class WebhookTeamEditedRepositoryOwner
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookTeamEditedRepositoryOwner" /> class.
        /// </summary>
        ...
        public WebhookTeamEditedRepositoryOwner(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhookTeamEditedRepositoryOwnerType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
