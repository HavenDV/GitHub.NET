...
namespace GitHub
{
    ...
    {
        partial void PrepareEnterpriseTeamsCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string enterprise,
            global::GitHub.EnterpriseTeamsCreateRequest request);
        partial void PrepareEnterpriseTeamsCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string enterprise,
            global::GitHub.EnterpriseTeamsCreateRequest request);
        partial void ProcessEnterpriseTeamsCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEnterpriseTeamsCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.EnterpriseTeam> EnterpriseTeamsCreateAsync(
            string enterprise,
            global::GitHub.EnterpriseTeamsCreateRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEnterpriseTeamsCreateArguments(
            ...
            PrepareEnterpriseTeamsCreateRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessEnterpriseTeamsCreateResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessEnterpriseTeamsCreateResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.EnterpriseTeam> EnterpriseTeamsCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.EnterpriseTeamsCreateRequest
            {
                Name = name,
            ...
            return await EnterpriseTeamsCreateAsync(
                enterprise: enterprise,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
