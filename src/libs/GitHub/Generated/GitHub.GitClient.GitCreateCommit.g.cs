    ...
    public partial class GitClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.GitCommit.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.GitCommit.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.GitCommit> GitCreateCommitAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.GitCreateCommitRequest
            {
                Message = message,
                Tree = tree,
                Parents = parents,
