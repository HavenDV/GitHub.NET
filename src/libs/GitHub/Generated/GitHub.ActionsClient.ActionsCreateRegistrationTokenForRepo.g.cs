...
namespace GitHub
{
    public partial class ActionsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.AuthenticationToken> ActionsCreateRegistrationTokenForRepoAsync(
            string owner,
            string repo,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.AbsoluteUri.TrimEnd('/') + $"/repos/{owner}/{repo}/actions/runners/registration-token", global::System.UriKind.RelativeOrAbsolute));
            ...
            return
                global::System.Text.Json.JsonSerializer.Deserialize(__content, global::GitHub.SourceGenerationContext.Default.AuthenticationToken) ??
