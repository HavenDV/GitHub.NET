...
namespace GitHub
{
    ...
    {
        partial void PrepareCampaignsGetCampaignSummaryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref int campaignNumber);
        partial void PrepareCampaignsGetCampaignSummaryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            int campaignNumber);
        partial void ProcessCampaignsGetCampaignSummaryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCampaignsGetCampaignSummaryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.CampaignSummary> CampaignsGetCampaignSummaryAsync(
            string org,
            int campaignNumber,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCampaignsGetCampaignSummaryArguments(
            ...
            PrepareCampaignsGetCampaignSummaryRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCampaignsGetCampaignSummaryResponse(
                httpClient: HttpClient,
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                global::GitHub.CampaignsGetCampaignSummaryResponse? __value_503 = null;
                if (ReadResponseAsString)
                {
                    __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = global::GitHub.CampaignsGetCampaignSummaryResponse.FromJson(__content_503, JsonSerializerContext);
                }
                else
                {
                    var __contentStream_503 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = await global::GitHub.CampaignsGetCampaignSummaryResponse.FromJsonStreamAsync(__contentStream_503, JsonSerializerContext).ConfigureAwait(false);
                }

                throw new global::GitHub.ApiException<global::GitHub.CampaignsGetCampaignSummaryResponse>(
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCampaignsGetCampaignSummaryResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
