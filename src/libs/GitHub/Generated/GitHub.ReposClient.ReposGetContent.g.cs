...
namespace GitHub
{
    public partial class ReposClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.ContentTree> ReposGetContentAsync(
            string owner,
            string repo,
            string path,
            string @ref,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.AbsoluteUri.TrimEnd('/') + $"/repos/{owner}/{repo}/contents/{path}?ref={@ref}", global::System.UriKind.RelativeOrAbsolute));
            ...
            return
                global::System.Text.Json.JsonSerializer.Deserialize(__content, global::GitHub.SourceGenerationContext.Default.ContentTree) ??
