...
namespace GitHub
{
    ...
    {
        partial void PrepareProjectsListFieldsForOrgArguments(
            ...
            ref string? before,
            ref string? after);
        partial void PrepareProjectsListFieldsForOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? before,
            string? after);
        partial void ProcessProjectsListFieldsForOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsListFieldsForOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::GitHub.ProjectsV2Field>> ProjectsListFieldsForOrgAsync(
            int projectNumber,
            string org,
            int? perPage = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsListFieldsForOrgArguments(
            ...
            PrepareProjectsListFieldsForOrgRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessProjectsListFieldsForOrgResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessProjectsListFieldsForOrgResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::GitHub.ProjectsV2Field>), JsonSerializerContext) as global::System.Collections.Generic.IList<global::GitHub.ProjectsV2Field> ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::GitHub.ProjectsV2Field>), JsonSerializerContext).ConfigureAwait(false) as global::System.Collections.Generic.IList<global::GitHub.ProjectsV2Field> ??
