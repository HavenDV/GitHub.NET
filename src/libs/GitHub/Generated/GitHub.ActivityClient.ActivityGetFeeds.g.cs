...
namespace GitHub
{
    public partial class ActivityClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Feed> ActivityGetFeedsAsync(
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.Feed.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.Feed.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
