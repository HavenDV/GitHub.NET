...
namespace GitHub
{
    ...
    public sealed partial class WebhookPullRequestReviewCommentCreatedCommentReactions
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPullRequestReviewCommentCreatedCommentReactions" /> class.
        /// </summary>
...
#endif
        public WebhookPullRequestReviewCommentCreatedCommentReactions(
            int plus1,
            int minus1,
            int confused,
            int eyes,
