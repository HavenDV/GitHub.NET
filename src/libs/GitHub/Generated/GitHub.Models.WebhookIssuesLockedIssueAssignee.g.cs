...
namespace GitHub
{
    ...
    public sealed partial class WebhookIssuesLockedIssueAssignee
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookIssuesLockedIssueAssignee" /> class.
        /// </summary>
...
#endif
        public WebhookIssuesLockedIssueAssignee(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhookIssuesLockedIssueAssigneeType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
