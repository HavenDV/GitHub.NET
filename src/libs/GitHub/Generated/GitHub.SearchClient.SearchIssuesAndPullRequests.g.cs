    ...
    public partial class SearchClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                global::GitHub.SearchIssuesAndPullRequestsResponse2? __value_503 = null;
                if (ReadResponseAsString)
                {
                    __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = global::GitHub.SearchIssuesAndPullRequestsResponse2.FromJson(__content_503, JsonSerializerContext);
                }
                else
                {
                    var __contentStream_503 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = await global::GitHub.SearchIssuesAndPullRequestsResponse2.FromJsonStreamAsync(__contentStream_503, JsonSerializerContext).ConfigureAwait(false);
                }

                throw new global::GitHub.ApiException<global::GitHub.SearchIssuesAndPullRequestsResponse2>(
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.SearchIssuesAndPullRequestsResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.SearchIssuesAndPullRequestsResponse.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
