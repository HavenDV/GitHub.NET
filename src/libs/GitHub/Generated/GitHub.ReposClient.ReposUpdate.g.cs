...
namespace GitHub
{
    public partial class ReposClient
    {
        partial void PrepareReposUpdateArguments(
            ...
            ref string owner,
            ref string repo,
            global::GitHub.ReposUpdateRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.FullRepository> ReposUpdateAsync(
            string owner,
            string repo,
            global::GitHub.ReposUpdateRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 307)
            {
                ...
                global::GitHub.BasicError? __value_307 = null;
                if (ReadResponseAsString)
                {
                    __content_307 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                    __value_307 = global::GitHub.BasicError.FromJson(__content_307, JsonSerializerContext);
                }
                else
                {
                    var __contentStream_307 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                    __value_307 = await global::GitHub.BasicError.FromJsonStreamAsync(__contentStream_307, JsonSerializerContext).ConfigureAwait(false);
                }
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.FullRepository.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.FullRepository> ReposUpdateAsync(
            ...
            global::GitHub.ReposUpdateRequestVisibility? visibility = default,
            global::GitHub.ReposUpdateRequestSecurityAndAnalysis? securityAndAnalysis = default,
            ...
            global::GitHub.ReposUpdateRequestSquashMergeCommitTitle? squashMergeCommitTitle = default,
            global::GitHub.ReposUpdateRequestSquashMergeCommitMessage? squashMergeCommitMessage = default,
            global::GitHub.ReposUpdateRequestMergeCommitTitle? mergeCommitTitle = default,
            global::GitHub.ReposUpdateRequestMergeCommitMessage? mergeCommitMessage = default,
            bool? archived = default,
            bool? allowForking = default,
            bool? webCommitSignoffRequired = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.ReposUpdateRequest
            {
                Name = name,
