...
namespace GitHub
{
    public partial class MetaClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Root> MetaRootAsync(
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.Root.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.Root.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
