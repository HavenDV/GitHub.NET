...
namespace GitHub
{
    public partial class OrgsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.OrganizationRole> OrgsGetOrgRoleAsync(
            string org,
            int roleId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.OrganizationRole.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.OrganizationRole.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
