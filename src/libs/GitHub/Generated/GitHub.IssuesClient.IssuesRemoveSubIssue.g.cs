...
namespace GitHub
{
    ...
    {
        partial void PrepareIssuesRemoveSubIssueArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref int issueNumber,
            global::GitHub.IssuesRemoveSubIssueRequest request);
        partial void PrepareIssuesRemoveSubIssueRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int issueNumber,
            global::GitHub.IssuesRemoveSubIssueRequest request);
        partial void ProcessIssuesRemoveSubIssueResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessIssuesRemoveSubIssueResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Issue> IssuesRemoveSubIssueAsync(
            string owner,
            string repo,
            int issueNumber,
            global::GitHub.IssuesRemoveSubIssueRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareIssuesRemoveSubIssueArguments(
            ...
            PrepareIssuesRemoveSubIssueRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessIssuesRemoveSubIssueResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessIssuesRemoveSubIssueResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Issue> IssuesRemoveSubIssueAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.IssuesRemoveSubIssueRequest
            {
                SubIssueId = subIssueId,
            };

            return await IssuesRemoveSubIssueAsync(
                owner: owner,
                repo: repo,
                issueNumber: issueNumber,
                request: __request,
