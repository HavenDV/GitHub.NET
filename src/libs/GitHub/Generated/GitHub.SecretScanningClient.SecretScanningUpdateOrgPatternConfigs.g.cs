...
namespace GitHub
{
    ...
    {
        partial void PrepareSecretScanningUpdateOrgPatternConfigsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            global::GitHub.SecretScanningUpdateOrgPatternConfigsRequest request);
        partial void PrepareSecretScanningUpdateOrgPatternConfigsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            global::GitHub.SecretScanningUpdateOrgPatternConfigsRequest request);
        partial void ProcessSecretScanningUpdateOrgPatternConfigsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSecretScanningUpdateOrgPatternConfigsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.SecretScanningUpdateOrgPatternConfigsResponse> SecretScanningUpdateOrgPatternConfigsAsync(
            string org,
            global::GitHub.SecretScanningUpdateOrgPatternConfigsRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSecretScanningUpdateOrgPatternConfigsArguments(
            ...
            PrepareSecretScanningUpdateOrgPatternConfigsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessSecretScanningUpdateOrgPatternConfigsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessSecretScanningUpdateOrgPatternConfigsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::GitHub.SecretScanningUpdateOrgPatternConfigsResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::GitHub.SecretScanningUpdateOrgPatternConfigsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.SecretScanningUpdateOrgPatternConfigsResponse> SecretScanningUpdateOrgPatternConfigsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.SecretScanningUpdateOrgPatternConfigsRequest
            {
            ...
            return await SecretScanningUpdateOrgPatternConfigsAsync(
                org: org,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
