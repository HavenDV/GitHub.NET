...
namespace GitHub
{
    public partial class GistsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.BaseGist> GistsForkAsync(
            string gistId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.BaseGist.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.BaseGist.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
