...
namespace GitHub
{
    ...
    public sealed partial class WebhooksPullRequest5User
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhooksPullRequest5User" /> class.
        /// </summary>
        ...
        public WebhooksPullRequest5User(
            long id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhooksPullRequest5UserType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
