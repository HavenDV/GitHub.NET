...
namespace GitHub
{
    ...
    public sealed partial class WebhookPackageUpdatedPackageOwner
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPackageUpdatedPackageOwner" /> class.
        /// </summary>
        ...
        public WebhookPackageUpdatedPackageOwner(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhookPackageUpdatedPackageOwnerType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
