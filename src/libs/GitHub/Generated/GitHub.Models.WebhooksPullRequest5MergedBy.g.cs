...
namespace GitHub
{
    ...
    public sealed partial class WebhooksPullRequest5MergedBy
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhooksPullRequest5MergedBy" /> class.
        /// </summary>
        ...
        public WebhooksPullRequest5MergedBy(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhooksPullRequest5MergedByType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
