...
namespace GitHub
{
    public partial class GitClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.GitCommit> GitGetCommitAsync(
            string owner,
            string repo,
            string commitSha,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.AbsoluteUri.TrimEnd('/') + $"/repos/{owner}/{repo}/git/commits/{commitSha}", global::System.UriKind.RelativeOrAbsolute));
