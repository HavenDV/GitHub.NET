    ...
    public partial class ChecksClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.ChecksListForSuiteResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.ChecksListForSuiteResponse.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
