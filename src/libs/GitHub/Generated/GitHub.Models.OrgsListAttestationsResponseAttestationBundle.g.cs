...
namespace GitHub
{
    ...
    public sealed partial class OrgsListAttestationsResponseAttestationBundle
    {
        ...
        public global::GitHub.OrgsListAttestationsResponseAttestationBundleVerificationMaterial? VerificationMaterial { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("dsseEnvelope")]
        public global::GitHub.OrgsListAttestationsResponseAttestationBundleDsseEnvelope? DsseEnvelope { get; set; }
