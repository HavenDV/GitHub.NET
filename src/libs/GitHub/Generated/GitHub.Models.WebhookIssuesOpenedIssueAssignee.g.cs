...
namespace GitHub
{
    ...
    public sealed partial class WebhookIssuesOpenedIssueAssignee
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookIssuesOpenedIssueAssignee" /> class.
        /// </summary>
...
#endif
        public WebhookIssuesOpenedIssueAssignee(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhookIssuesOpenedIssueAssigneeType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
