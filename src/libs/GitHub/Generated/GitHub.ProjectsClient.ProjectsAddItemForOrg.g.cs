...
namespace GitHub
{
    ...
    {
        partial void PrepareProjectsAddItemForOrgArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref int projectNumber,
            global::GitHub.ProjectsAddItemForOrgRequest request);
        partial void PrepareProjectsAddItemForOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            int projectNumber,
            global::GitHub.ProjectsAddItemForOrgRequest request);
        partial void ProcessProjectsAddItemForOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsAddItemForOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.ProjectsV2ItemSimple> ProjectsAddItemForOrgAsync(
            string org,
            int projectNumber,
            global::GitHub.ProjectsAddItemForOrgRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsAddItemForOrgArguments(
            ...
            PrepareProjectsAddItemForOrgRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessProjectsAddItemForOrgResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessProjectsAddItemForOrgResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::GitHub.ProjectsV2ItemSimple.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::GitHub.ProjectsV2ItemSimple.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.ProjectsV2ItemSimple> ProjectsAddItemForOrgAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.ProjectsAddItemForOrgRequest
            {
                Type = type,
                Id = id,
            };

            return await ProjectsAddItemForOrgAsync(
                org: org,
                projectNumber: projectNumber,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
