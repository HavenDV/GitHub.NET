...
namespace GitHub
{
    public partial class ActionsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.ActionsCacheUsageByRepository> ActionsGetActionsCacheUsageAsync(
            string owner,
            string repo,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::GitHub.ActionsCacheUsageByRepository.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.ActionsCacheUsageByRepository.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
