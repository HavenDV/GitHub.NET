...
namespace GitHub
{
    ...
    public sealed partial class WebhookDeploymentReviewRejectedWorkflowRunRepositoryOwner
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDeploymentReviewRejectedWorkflowRunRepositoryOwner" /> class.
        /// </summary>
        ...
        public WebhookDeploymentReviewRejectedWorkflowRunRepositoryOwner(
            string? avatarUrl,
            string? eventsUrl,
            string? followersUrl,
            string? followingUrl,
