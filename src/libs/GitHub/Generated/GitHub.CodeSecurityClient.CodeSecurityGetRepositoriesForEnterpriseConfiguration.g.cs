...
namespace GitHub
{
    ...
    {
        partial void PrepareCodeSecurityGetRepositoriesForEnterpriseConfigurationArguments(
            ...
            ref string? after,
            ref string? status);
        partial void PrepareCodeSecurityGetRepositoriesForEnterpriseConfigurationRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after,
            string? status);
        partial void ProcessCodeSecurityGetRepositoriesForEnterpriseConfigurationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCodeSecurityGetRepositoriesForEnterpriseConfigurationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get repositories associated with an enterprise code security configuration<br/>
        /// Lists the repositories associated with an enterprise code security configuration in an organization.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::GitHub.CodeSecurityConfigurationRepositories>> CodeSecurityGetRepositoriesForEnterpriseConfigurationAsync(
            string enterprise,
            int configurationId,
            int? perPage = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCodeSecurityGetRepositoriesForEnterpriseConfigurationArguments(
            ...
            PrepareCodeSecurityGetRepositoriesForEnterpriseConfigurationRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCodeSecurityGetRepositoriesForEnterpriseConfigurationResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCodeSecurityGetRepositoriesForEnterpriseConfigurationResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
