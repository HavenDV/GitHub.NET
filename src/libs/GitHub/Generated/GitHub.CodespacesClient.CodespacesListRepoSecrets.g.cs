...
namespace GitHub
{
    public partial class CodespacesClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.CodespacesListRepoSecretsResponse> CodespacesListRepoSecretsAsync(
            string owner,
            string repo,
            int perPage,
            int page,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.AbsoluteUri.TrimEnd('/') + $"/repos/{owner}/{repo}/codespaces/secrets?per_page={perPage}&page={page}", global::System.UriKind.RelativeOrAbsolute));
            ...
            return
                global::System.Text.Json.JsonSerializer.Deserialize(__content, global::GitHub.SourceGenerationContext.Default.CodespacesListRepoSecretsResponse) ??
