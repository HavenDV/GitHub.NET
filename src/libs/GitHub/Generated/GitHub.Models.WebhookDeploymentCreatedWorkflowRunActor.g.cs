...
namespace GitHub
{
    ...
    public sealed partial class WebhookDeploymentCreatedWorkflowRunActor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDeploymentCreatedWorkflowRunActor" /> class.
        /// </summary>
        ...
        public WebhookDeploymentCreatedWorkflowRunActor(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhookDeploymentCreatedWorkflowRunActorType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
