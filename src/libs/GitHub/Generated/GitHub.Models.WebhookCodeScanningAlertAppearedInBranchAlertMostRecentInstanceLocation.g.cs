...
namespace GitHub
{
    ...
    public sealed partial class WebhookCodeScanningAlertAppearedInBranchAlertMostRecentInstanceLocation
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookCodeScanningAlertAppearedInBranchAlertMostRecentInstanceLocation" /> class.
        /// </summary>
...
#endif
        public WebhookCodeScanningAlertAppearedInBranchAlertMostRecentInstanceLocation(
            int? endColumn,
            int? endLine,
            string? path,
            int? startColumn,
