...
namespace GitHub
{
    public partial class CodespacesClient
    {
        partial void PrepareCodespacesCreateWithRepoForAuthenticatedUserArguments(
            ...
            ref string owner,
            ref string repo,
            global::GitHub.CodespacesCreateWithRepoForAuthenticatedUserRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Codespace> CodespacesCreateWithRepoForAuthenticatedUserAsync(
            string owner,
            string repo,
            global::GitHub.CodespacesCreateWithRepoForAuthenticatedUserRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                global::GitHub.CodespacesCreateWithRepoForAuthenticatedUserResponse? __value_503 = null;
                if (ReadResponseAsString)
                {
                    __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = global::GitHub.CodespacesCreateWithRepoForAuthenticatedUserResponse.FromJson(__content_503, JsonSerializerContext);
                }
                else
                {
                    var __contentStream_503 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = await global::GitHub.CodespacesCreateWithRepoForAuthenticatedUserResponse.FromJsonStreamAsync(__contentStream_503, JsonSerializerContext).ConfigureAwait(false);
                }

                throw new global::GitHub.ApiException<global::GitHub.CodespacesCreateWithRepoForAuthenticatedUserResponse>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            else
            {
                ...
                var __responseValue = await global::GitHub.Codespace.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Codespace> CodespacesCreateWithRepoForAuthenticatedUserAsync(
            ...
            global::GitHub.CodespacesCreateWithRepoForAuthenticatedUserRequestGeo? geo = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.CodespacesCreateWithRepoForAuthenticatedUserRequest
            {
                Ref = @ref,
                Location = location,
                Geo = geo,
