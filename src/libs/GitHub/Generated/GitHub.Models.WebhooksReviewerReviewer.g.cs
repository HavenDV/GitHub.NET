...
namespace GitHub
{
    ...
    public sealed partial class WebhooksReviewerReviewer
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhooksReviewerReviewer" /> class.
        /// </summary>
        ...
        public WebhooksReviewerReviewer(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.WebhooksReviewerReviewerType? type,
            string? url)
        {
            this.Id = id;
