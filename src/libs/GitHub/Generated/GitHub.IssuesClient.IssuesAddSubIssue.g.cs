...
namespace GitHub
{
    ...
    {
        partial void PrepareIssuesAddSubIssueArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref int issueNumber,
            global::GitHub.IssuesAddSubIssueRequest request);
        partial void PrepareIssuesAddSubIssueRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int issueNumber,
            global::GitHub.IssuesAddSubIssueRequest request);
        partial void ProcessIssuesAddSubIssueResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessIssuesAddSubIssueResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// <summary>
        /// Add sub-issue<br/>
        /// You can use the REST API to add sub-issues to issues.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Issue> IssuesAddSubIssueAsync(
            string owner,
            string repo,
            int issueNumber,
            global::GitHub.IssuesAddSubIssueRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareIssuesAddSubIssueArguments(
            ...
            PrepareIssuesAddSubIssueRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessIssuesAddSubIssueResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessIssuesAddSubIssueResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.Issue> IssuesAddSubIssueAsync(
            ...
            int issueNumber,
            int subIssueId,
            bool? replaceParent = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.IssuesAddSubIssueRequest
            {
                SubIssueId = subIssueId,
                ReplaceParent = replaceParent,
            };

            return await IssuesAddSubIssueAsync(
                owner: owner,
                repo: repo,
                issueNumber: issueNumber,
                request: __request,
