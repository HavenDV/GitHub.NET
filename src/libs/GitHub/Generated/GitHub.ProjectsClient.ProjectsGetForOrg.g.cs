...
namespace GitHub
{
    ...
    {
        partial void PrepareProjectsGetForOrgArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int projectNumber,
            ref string org);
        partial void PrepareProjectsGetForOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int projectNumber,
            string org);
        partial void ProcessProjectsGetForOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsGetForOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.ProjectsV2> ProjectsGetForOrgAsync(
            int projectNumber,
            string org,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsGetForOrgArguments(
            ...
            PrepareProjectsGetForOrgRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessProjectsGetForOrgResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessProjectsGetForOrgResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::GitHub.ProjectsV2.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::GitHub.ProjectsV2.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
