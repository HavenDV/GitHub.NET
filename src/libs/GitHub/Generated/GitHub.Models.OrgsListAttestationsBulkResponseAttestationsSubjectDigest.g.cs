...
namespace GitHub
{
    ...
    public sealed partial class OrgsListAttestationsBulkResponseAttestationsSubjectDigest
    {
        ...
        public global::GitHub.OrgsListAttestationsBulkResponseAttestationsSubjectDigestBundle? Bundle { get; set; }
        ...
        public OrgsListAttestationsBulkResponseAttestationsSubjectDigest(
            global::GitHub.OrgsListAttestationsBulkResponseAttestationsSubjectDigestBundle? bundle,
            int? repositoryId,
            string? bundleUrl)
        {
            this.Bundle = bundle;
