...
namespace GitHub
{
    ...
    {
        partial void PrepareCodeScanningCommitAutofixArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref int alertNumber,
            global::GitHub.CodeScanningAutofixCommits request);
        partial void PrepareCodeScanningCommitAutofixRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int alertNumber,
            global::GitHub.CodeScanningAutofixCommits request);
        partial void ProcessCodeScanningCommitAutofixResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCodeScanningCommitAutofixResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.CodeScanningAutofixCommitsResponse> CodeScanningCommitAutofixAsync(
            string owner,
            string repo,
            int alertNumber,
            global::GitHub.CodeScanningAutofixCommits request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCodeScanningCommitAutofixArguments(
            ...
            PrepareCodeScanningCommitAutofixRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCodeScanningCommitAutofixResponse(
                httpClient: HttpClient,
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                global::GitHub.CodeScanningCommitAutofixResponse? __value_503 = null;
                if (ReadResponseAsString)
                {
                    __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = global::GitHub.CodeScanningCommitAutofixResponse.FromJson(__content_503, JsonSerializerContext);
                }
                else
                {
                    var __contentStream_503 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = await global::GitHub.CodeScanningCommitAutofixResponse.FromJsonStreamAsync(__contentStream_503, JsonSerializerContext).ConfigureAwait(false);
                }

                throw new global::GitHub.ApiException<global::GitHub.CodeScanningCommitAutofixResponse>(
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCodeScanningCommitAutofixResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::GitHub.CodeScanningAutofixCommitsResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::GitHub.CodeScanningAutofixCommitsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.CodeScanningAutofixCommitsResponse> CodeScanningCommitAutofixAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.CodeScanningAutofixCommits
            {
                TargetRef = targetRef,
                Message = message,
            };

            return await CodeScanningCommitAutofixAsync(
                owner: owner,
                repo: repo,
                alertNumber: alertNumber,
                request: __request,
