...
namespace GitHub
{
    ...
    public sealed partial class DiscussionAnswerChosenBy
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DiscussionAnswerChosenBy" /> class.
        /// </summary>
        ...
        public DiscussionAnswerChosenBy(
            int id,
            string login,
            string? avatarUrl,
            bool? deleted,
            ...
            global::GitHub.DiscussionAnswerChosenByType? type,
            string? url,
            string? userViewType)
        {
            this.Id = id;
