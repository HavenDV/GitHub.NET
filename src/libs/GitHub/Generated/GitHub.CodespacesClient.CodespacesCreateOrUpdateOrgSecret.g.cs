...
namespace GitHub
{
    ...
    {
        partial void PrepareCodespacesCreateOrUpdateOrgSecretArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref string secretName,
            global::GitHub.CodespacesCreateOrUpdateOrgSecretRequest request);
        partial void PrepareCodespacesCreateOrUpdateOrgSecretRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            string secretName,
            global::GitHub.CodespacesCreateOrUpdateOrgSecretRequest request);
        partial void ProcessCodespacesCreateOrUpdateOrgSecretResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCodespacesCreateOrUpdateOrgSecretResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.EmptyObject> CodespacesCreateOrUpdateOrgSecretAsync(
            string org,
            string secretName,
            global::GitHub.CodespacesCreateOrUpdateOrgSecretRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: _httpClient);
            PrepareCodespacesCreateOrUpdateOrgSecretArguments(
            ...
            var __httpRequestContentBody = global::System.Text.Json.JsonSerializer.Serialize(request, global::GitHub.SourceGenerationContext.Default.CodespacesCreateOrUpdateOrgSecretRequest);
            ...
            PrepareRequest(
                client: _httpClient,
                request: httpRequest);
            PrepareCodespacesCreateOrUpdateOrgSecretRequest(
                httpClient: _httpClient,
            ...
            ProcessResponse(
                client: _httpClient,
                response: response);
            ProcessCodespacesCreateOrUpdateOrgSecretResponse(
                httpClient: _httpClient,
            ...
            ProcessCodespacesCreateOrUpdateOrgSecretResponseContent(
                httpClient: _httpClient,
                httpResponseMessage: response,
                content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.EmptyObject> CodespacesCreateOrUpdateOrgSecretAsync(
            string org,
            string secretName,
            global::GitHub.CodespacesCreateOrUpdateOrgSecretRequestVisibility visibility,
            string? encryptedValue = default,
            string? keyId = default,
            global::System.Collections.Generic.IList<int>? selectedRepositoryIds = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var request = new global::GitHub.CodespacesCreateOrUpdateOrgSecretRequest
            {
