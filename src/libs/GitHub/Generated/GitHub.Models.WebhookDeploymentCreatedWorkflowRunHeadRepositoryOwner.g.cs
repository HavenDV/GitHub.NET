...
namespace GitHub
{
    ...
    public sealed partial class WebhookDeploymentCreatedWorkflowRunHeadRepositoryOwner
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDeploymentCreatedWorkflowRunHeadRepositoryOwner" /> class.
        /// </summary>
...
#endif
        public WebhookDeploymentCreatedWorkflowRunHeadRepositoryOwner(
            string? avatarUrl,
            string? eventsUrl,
            string? followersUrl,
            string? followingUrl,
