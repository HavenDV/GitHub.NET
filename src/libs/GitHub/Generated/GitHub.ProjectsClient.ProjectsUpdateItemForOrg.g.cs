...
namespace GitHub
{
    ...
    {
        partial void PrepareProjectsUpdateItemForOrgArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int projectNumber,
            ref string org,
            ref int itemId,
            global::GitHub.ProjectsUpdateItemForOrgRequest request);
        partial void PrepareProjectsUpdateItemForOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int itemId,
            global::GitHub.ProjectsUpdateItemForOrgRequest request);
        partial void ProcessProjectsUpdateItemForOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsUpdateItemForOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.ProjectsV2ItemWithContent> ProjectsUpdateItemForOrgAsync(
            int projectNumber,
            string org,
            int itemId,
            global::GitHub.ProjectsUpdateItemForOrgRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsUpdateItemForOrgArguments(
            ...
            PrepareProjectsUpdateItemForOrgRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessProjectsUpdateItemForOrgResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessProjectsUpdateItemForOrgResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::GitHub.ProjectsV2ItemWithContent.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::GitHub.ProjectsV2ItemWithContent.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::GitHub.ProjectsV2ItemWithContent> ProjectsUpdateItemForOrgAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GitHub.ProjectsUpdateItemForOrgRequest
            {
                Fields = fields,
            };

            return await ProjectsUpdateItemForOrgAsync(
                projectNumber: projectNumber,
                org: org,
                itemId: itemId,
                request: __request,
